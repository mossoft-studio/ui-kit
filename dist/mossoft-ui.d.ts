...
export declare const Input: <TFieldValues extends FieldValues, TName extends FieldPath<TFieldValues>>({ size, type, field, label, fieldState, postfix, labelClassName, className, numberWrapperClassname, format, wrapperClassName, decimalScale, floatingLabel, requiredMark, id, ...rest }: Props_6<TFieldValues, TName>) => JSX_2.Element;
