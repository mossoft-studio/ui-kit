...
var css_248z$2 = ".input-module_input__Zv-41{--tw-border-opacity:1;--tw-bg-opacity:1;--tw-text-opacity:1;background-color:rgb(245 245 245/var(--tw-bg-opacity));border-color:rgb(245 245 245/var(--tw-border-opacity));border-radius:30px;border-width:1px;color:rgb(0 0 0/var(--tw-text-opacity));display:block;font-size:.875rem;font-weight:400;line-height:1.25rem;padding:14px;transition-duration:.3s;transition-property:all;transition-timing-function:cubic-bezier(.4,0,.2,1);width:100%}.input-module_input__Zv-41::placeholder{--tw-text-opacity:1;color:rgb(153 153 153/var(--tw-text-opacity))}@media (min-width:1023px){.input-module_input__Zv-41{--tw-border-opacity:1;--tw-bg-opacity:1;background-color:rgb(255 255 255/var(--tw-bg-opacity));border-color:rgb(255 255 255/var(--tw-border-opacity));border-radius:15px;font-size:1rem;line-height:1.5rem;padding:10px}}";
var styles$2 = {"input":"input-module_input__Zv-41"};
...
const Input = ({
  ...
  return React.createElement(React.Fragment, null, format ? React.createElement(PatternFormat, Object.assign({
    ...
    type: type,
    mask: "_",
    className: `${!!fieldState?.error && errorClass} ${className} ${styles$2.input}`,
    format: format
    ...
    value: field?.value?.toString(),
    className: `${className} ${styles$2.input}`
