...
const Select: React.FC<Props> = ({
  ...
  return (
    <div>
      <div className="relative w-full min-w-[190px] after:absolute after:right-4 after:top-0 after:bottom-0 after:my-auto after:w-2 after:h-2 after:border-t-2 after:border-r-2 after:border-dark-gray after:rotate-[134deg] after:transition-all after:duration-300">
        <select
          {...field}
          {...rest}
          defaultValue=""
